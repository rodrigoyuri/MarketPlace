...
@section('content')
    ...
    <div class="row front">
        ...
        <div class="col-4">
            ...
            @else 
                <img src="http://via.placeholder.com/450x100.png?text=logo" alt="Logo da Loja {{$store->name}} " class="img-fluid">
            @endif
        </div>
       ...
       @empty
            <div class="col-12">
                <h4 class="alert alert-warning">Nenhum Produto encontrado para essa Loja...</h4>
            </div>
       @endforelse
    </div>
